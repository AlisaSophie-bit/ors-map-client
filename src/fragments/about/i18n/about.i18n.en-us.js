...
export default {
  about: {
    donate: 'Donate!',
    info_I: 'This is a Techlabs Copenhagen Project. Enjoy!',
    ...
    info_III: 'Users are prohibited from any commercial, non-free resale, or redistribution without explicit written permission from CIAT. Original data by Jarvis A., H.I. Reuter, A. Nelson, E. Guevara, 2008, Hole-filled seamless SRTM data V4, International Centre for Tropical Agriculture (CIAT)',
    ...
    dataProvided: 'Population data provided by',
    ghsFramework: 'The Global Human Settlement (GHS) frameworks',
    askOpenrouteservice: 'Ask JOGGY',
    termsOfService: 'Terms of Service',
    privacyPolicy: 'Privacy Policy',
    openStreetMapOrg: 'OpenStreetMap.org',
    infoSupport: 'Please support JOGGY',
    supportText: 'JOGGY offers free services and relies on donations for a majority of its funding. If you would like to support the further development of features and server infrastructure donations are very welcome.',
